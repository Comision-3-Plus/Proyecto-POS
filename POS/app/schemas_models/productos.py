...
class ProductoBase(BaseModel):
    ...
    unidad_medida: str = Field(default="UNIDAD", description="UNIDAD, KILO, LITRO, METRO")
...
class ProductoUpdate(BaseModel):
    ...
    unidad_medida: Optional[str] = Field(None, description="UNIDAD, KILO, LITRO, METRO")
...
class ProductoRead(ProductoBase):
    ...
    updated_at: datetime
    tienda_id: UUID
    atributos: Optional[Dict[str, Any]] = Field(default_factory=dict)  # ⚡ FIX: Aceptar None y default a {}
