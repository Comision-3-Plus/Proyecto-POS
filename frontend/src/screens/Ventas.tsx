...
export default function Ventas() {
  ...
  const subtotal = cart.reduce((sum: number, item: CartItem) => sum + item.precio * item.cantidad, 0);
  const tax = subtotal * 0.21;
  const total = subtotal + tax;

  const handleScan = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: Implementar escaneo RFID
    console.log('Escaneando:', scanInput);
    setScanInput('');
  };
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 pt-1">
                    ...
                    <div className="flex items-center gap-2 mt-3">
                      <button className="w-7 h-7 rounded-lg border border-gray-200 flex items-center justify-center hover:bg-gradient-to-br hover:from-gray-500 hover:to-gray-600 hover:border-transparent text-gray-600 hover:text-white transition-all shadow-sm hover:shadow-lg">
                        -
                      </button>
                      ...
                      <button className="w-7 h-7 rounded-lg border border-gray-200 flex items-center justify-center hover:bg-gradient-to-br hover:from-primary-500 hover:to-primary-600 hover:border-transparent text-gray-600 hover:text-white transition-all shadow-sm hover:shadow-lg hover:shadow-primary-500/40">
                        +
                      </button>
                    </div>
                  </div>
